...
def save_plot(examples, epoch, n):
    ...
    filename = f"/kaggle/working/samples/generated_plot_epoch-{epoch+1}.png"
...
if __name__ == "__main__":
    ...
    latent_dim = 128
    num_epochs = 50
    images_path = glob("/kaggle/input/anime-picture-dataset/data/data/data/*")
    ...
    for epoch in range(num_epochs):
        ...
        g_model.save("/kaggle/working/saved_model/g_model.h5")
        d_model.save("/kaggle/working/saved_model/d_model.h5")
